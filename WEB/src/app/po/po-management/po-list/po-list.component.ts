...
import { PoService, cSearch } from '../../po-management/po.service';
...
export class PoListComponent extends OriginalListComponent {
  ...
  //----------------------------------------------------------------
	...
	// constructor class
	//-----------------------------------------------------------------
	constructor(private unitS: PoService, private router: Router, 
