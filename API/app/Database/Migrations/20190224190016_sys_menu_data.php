...
class Migration_sys_menu_data extends \CodeIgniter\Database\Migration {
    ...
    public function up()
    {
		...
		(8,'M','Basic Master','Basic Master','/',1),
		(8,'M','Transaction Master','Transaction Master','/',2),
		(8,'M','Admin Master','Admin','/',2),
		(37,'S','บริษัท','บริษัท','/company/list',1),
		(37,'S','โรงงาน','โรงงาน','/factory/list',2),
		(37,'S','พื้นที่จัดเก็บ','พื้นที่จัดเก็บ','/location/list',3),
		(37,'S','สกุลเงิน','สกุลเงิน','/currency/list',4),
		(37,'S','หน่วยวัตถุดิบ','หน่วยวัตถุดิบ','/system/unit/list',5),
		(37,'S','ปฏิทิน','ปฏิทิน','/calendar/list',6),
		(38,'S','วัตถุดิบ','วัตถุดิบ','/system/item/list',1),
		(38,'S','โครงสร้างวัตถุดิบ','โครงสร้างวัตถุดิบ','/',2),
		(38,'S','ลูกค้า','ลูกค้า','/',3),
		(38,'S','ราคาขาย','ราคาขาย','/',4),
		(38,'S','ราคาซื้อ','ราคาซื้อ','/',5),
		(38,'S','ผู้ผลิต','ผู้ผลิต','/system/supplier/list',6),
		(39,'S','พนักงาน','พนักงาน','/',1)
